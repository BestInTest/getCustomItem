...
public class SnowballTeleport implements Listener {
    ...
    public SnowballTeleport(ItemManager itemManager, CooldownManager cooldownManager, Config config) {
    ...
    public void onHit(ProjectileHitEvent event) {
        ...
        if(event.getEntity() instanceof Snowball snowball) {
            ...
            Optional<CustomItem> customItemByType = itemManager.findCustomItemByType(ItemType.SNOWBALL_TP, item);
            if(customItemByType.isEmpty() || !(customItemByType.get() instanceof SnowballTPItem snowballTPItem))
                return;
